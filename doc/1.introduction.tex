\chapter{Introduction}
	...
	\section{Project Description}
		...
		\SocialBattle will take most of the features of a social network adding the 
	...
	\begin{itemize}
		...
		% our system. Even if it is not handled by a human mind it is the subject around which \SocialBattle 
		% will be built.
	\end{itemize}
